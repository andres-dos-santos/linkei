	...
	return (
		<div className="col-span-10 lg:col-span-6 row-span-8 lg:pl-10 xl:pl-20 flex flex-col items-start justify-start mt-2.5">
			...
			>
				...
				<button
					data-error={hasError}
					className="data-[error=true]:disabled disabled:cursor-not-allowed h-14 w-full bg-zinc-800 dark:bg-white hover:bg-zinc-900 dark:hover:bg-zinc-100 rounded flex items-center justify-center"
					type="submit"
				>
